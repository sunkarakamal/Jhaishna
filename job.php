...
<body>
    ...
    <div class="main bg-light">
        ...
        <section class="" style="background: url('assets/img/sliderjob.png')no-repeat center center / cover">
        ...
        <div class="col-12 mb-4 mt-4">
            <div class="card bg-white border-variant-soft shadow-soft">
                <div class="card-body">
                    ...
                    <br/>we would like to meet you. Interested Candidates can Share Your Resume To Mail Id: <a href="mailto:hr@jhaishna.com">hr@jhaishna.com</a></p>
                    <div class="text-right ml-0 pl-0">
            ...
            <div class="card bg-white border-variant-soft shadow-soft">
                <div class="card-body">
                    <div class="media d-flex align-items-center justify-content-between">
                        <div class="post-group">
                            <a href="contact.php" data-toggle="tooltip" data-placement="top" title="job role" data-original-title="">
                                <h3 class="h5 card-title mt-3">Social Media Marketing Executive</h3>
                            </a>
                        </div>
                        <span class="font-small">CTC - &#8377; 2,50,000 - 3,00,000 PA</span>
                    </div>
                    <div class="text-right">
                        <span class="small"><span class="fas fa-briefcase mr-2"></span>Experience - 7 to 8 years</span>
                    </div>
                    <span class="font-small"><strong>Description</strong></span>
                    <p class="card-text">We are looking for a candidate who has excellent communication skills, hands-on experience in content management.
                    <br/>One should have excellent copywriting skills and good knowledge of social media, Paid campaigns.
                    <br/>Core Skills: SEO, Creative Writing, Social Media Marketing.<br/>Other Skills: MS Office, Written & Verbal Communication, Content Writing (blogs etc.)
                    <br/>
