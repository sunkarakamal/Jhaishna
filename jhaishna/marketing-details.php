                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 col-lg-5 mb-4 mb-md-4 mt-lg-0">
                            <div class="hero-slider-content-8">
                                <h1 class="display-2"><span>Digital Advertising & Marketing</span> </h1>
                                <p class="lead">Master Digital Marketing Strategy, Social Media Marketing, SEO, YouTube, Email, Facebook Marketing, Analytics & More!</p>
                                <a href="contact.php" class="btn btn-secondary mt-4" data-toggle="modal" data-target="#enquiry">Enquiry Now</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-7">
                            <div class="image-wrap">
                                <img src="assets/img/training/digital.png" alt="digital" class="custom-img-width img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <aside class="widget widget-recent-entries-custom">
                                ...
                                <ul class="list-unstyled">
                                    <li class="clearfix d-flex align-items-center">
                                        ...
                                        <div class="wb"><a href="coming-soon.php">Content Writing</a><span class="post-date"></span></div>
                                    </li>
                                    <li class="clearfix d-flex align-items-center">
                                        <div class="wi">
                    ...
                    <div class="col-lg-8 col-md-8 order-0 order-sm-0 order-md-1 order-lg-1 mb-4 mb-md-0 mb-lg-0">
                                ...
                                <div class="card card-body shadow">
                                    <div class="d-flex">
                                        ...
                                        <div class="feature-content ">
                                            ...
                                            <p class="mb-0">
                                                <i class="fas fa-check"></i>&nbsp;Full understanding of Digital Marketing foundations
                                            </p>
                                            <p class="mb-0">
                                                <i class="fas fa-check"></i>&nbsp;What we mean by marketing vs. advertising
                                            </p>
                                            <p class="mb-0">
                                                <i class="fas fa-check"></i>&nbsp;ork From Home as a Freelance Marketer
                                            </p>
                                            <p class="mb-0">
                                                <i class="fas fa-check"></i>&nbsp;Understand social media advertising
                                            </p>
                                            <p class="mb-0">
                                                <i class="fas fa-check"></i>&nbsp;An understanding of the complex way digital advertising companies work together
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card card-sm px-4 py-1 border border-light rounded mb-0">
                                                ...
                                                <div class="collapse" id="panel-2">
                                                    <div class="accordion-content">
                                                        <p class="mb-0">
                                                            <i class="fas fa-signature"></i>&nbsp;Content Writing
                                                        </p>
                                                        <p class="mb-0">
                                                            <i class="fab fa-searchengin"></i>&nbsp;SEO
                                                        </p>
                                                        <p class="mb-0">
                                                            <i class="fas fa-icons"></i>&nbsp;Social Media Marketing
                                                        </p>
                                                        <p class="mb-0">
                                                        ...
                                                        <p class="mb-0">
                                                            <i class="fab fa-facebook-square"></i>&nbsp;Facebook Ads
                                                        </p>
                                                        <p class="mb-0">
                                                            <i class="far fa-copyright"></i>&nbsp;Copywriting
                                                        </p>
                                                        <p class="mb-0">
                                                            <i class="fas fa-mail-bulk"></i>&nbsp;App Marketing
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="project-details-content">
                                    <ul class="list-unstyled tech-feature-list">
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Have some interest </strong> in the digital advertising industry</li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Suitable</strong> for all types of businesses</li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Desire</strong> to learn and enhance your skills</li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>No experience required!</strong></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-md-12">
                                ...
                                <div class="project-details-content">
                                    <p>This is one of the most comprehensive digital marketing courses available. We'll cover SEO, YouTube Marketing, Facebook Marketing, Google Adwords, Google Analytics and more!</p>
                                    <p>To successfully create and manage digital advertising campaigns on that scale you need to understand not just the basic advertising principles you learn in school, but fully understand the ever changing digital advertising ecosystem.</p>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-md-12">
                                ...
                                <div class="project-details-content">
                                    <ul class="list-unstyled tech-feature-list">
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Pre launch businessowners who don't know where to get started</strong></li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Website </strong>owners who are struggling to get traffic and sales</li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Anyone</strong> looking to start a pick up highly paid freelancing skills</li>
                                        <li class="py-1"><span class="ti-control-forward mr-2 text-secondary"></span><strong>Great for anyone </strong>working in advertising/sales, digital or otherwise, who wants an update on the digital space</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
