            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 d-none d-lg-block d-md-block">
                    <div class="topbar-text font-small font-weight-normal">
                        <a href="mailto:projects@jhaishna.com"><span class="mr-2"><i class="fas fa-envelope mr-1"></i>projects@jhaishna.com</span></a>
                        <span><i class="fas fa-map-marker-alt mr-1"></i>Vijayawada</span>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4">
                    <div class="topbar-text call-us-number font-small font-weight-normal text-lg-right">
                        <a href="tel:+91 9686544129"><span><i class="fas fa-phone-alt mr-2"></i>Call Now: <strong>7893696993 , 96865 44129</strong></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <header class="header position-relative z-9">
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-dark navbar-theme-primary fixed-top headroom">
            <div class="container position-relative">
                ...
                <img class="navbar-brand-dark" src="assets/img/viyaanwhite.png" alt="logo">
                    <img class="navbar-brand-light" src="assets/img/viyaanwhite.png" alt="logo"> 
                </a>
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="#">
                                    <img src="assets/img/viyaanwhite.png" alt="logo">
                                </a>
                            </div>
