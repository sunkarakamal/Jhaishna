<?php
    ...
    if ($conn->connect_error) {
        ...
        echo "<tr><th style='border: 1px solid #ddd; padding: 8px;'>Name</th><th style='border: 1px solid #ddd; padding: 8px;'>Email</th><th style='border: 1px solid #ddd; padding: 8px;'>Phone</th><th style='border: 1px solid #ddd; padding: 8px;'>Message</th></tr>";
